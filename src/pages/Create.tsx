          ...
          {fields.map((fld) => (
            <Paper
              ...
              sx={{
                ...
                mb: 1,
                bgcolor:
                  fld.id === selectedId ? theme.palette.action.selected : 'inherit',
                display: 'flex',
                alignItems: 'center',
            ...
            >
              ...
              <Box>
                <IconButton onClick={() => dispatch(moveField({ id: fld.id, direction: -1 }))} size="small">
                  <ArrowUpward fontSize="small" />
                </IconButton>
                <IconButton onClick={() => dispatch(moveField({ id: fld.id, direction: 1 }))} size="small">
                  <ArrowDownward fontSize="small" />
                </IconButton>
                <IconButton onClick={() => dispatch(removeField(fld.id))} size="small">
          ...
          {selected ? (
            <Paper sx={{ p: 2 }}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  dispatch(updateField({ id: selected.id, changes: { label: e.target.value } }))
                }
                sx={{ mt: 2 }}
              />
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      dispatch(updateField({ id: selected.id, changes: { required: e.target.checked } }))
                    }
                  />
                }
                label="Required"
              ...
              <TextField
                ...
                onChange={(e) =>
                  dispatch(updateField({ id: selected.id, changes: { defaultValue: e.target.value } }))
                }
                sx={{ mt: 2 }}
              />
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    dispatch(
                      updateField({
                        id: selected.id,
                        changes: { options: e.target.value.split(',').map((o) => o.trim()) },
                      })
                    )
                  }
                  sx={{ mt: 2 }}
                      ...
                      onChange={(e) =>
                        dispatch(
                          updateField({
                            id: selected.id,
                            changes: {
                              validations: { ...selected.validations, [key]: e.target.checked },
                            },
                          })
                        )
                      }
                ...
                onChange={(e) =>
                  dispatch(
                    updateField({
                      id: selected.id,
                      changes: {
                        validations: { ...selected.validations, minLength: Number(e.target.value) },
                      },
                    })
                  )
                }
                ...
                onChange={(e) =>
                  dispatch(
                    updateField({
                      id: selected.id,
                      changes: {
                        validations: { ...selected.validations, maxLength: Number(e.target.value) },
                      },
                    })
                  )
                }
              ...
              {selected.type === 'derived' && (
                <>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        dispatch(
                          updateField({
                            id: selected.id,
                            changes: { derivedParents: e.target.value as string[] },
                          })
                        )
                      }
                    >
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      dispatch(updateField({ id: selected.id, changes: { derivedFormula: e.target.value } }))
                    }
                    sx={{ mt: 1 }}
                  />
                </>
